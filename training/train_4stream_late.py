"""
train_4stream_late.py — Standalone Training Script for 4-Stream Late Fusion
========================================================================

This is the dedicated training script for the FourStreamSTGCN model
with LATE fusion (early_fusion=False).
...
Outputs:
    - models/sign_stgcn_4stream_late.pth
    - output/results_4stream_late.json
...
MODEL_SAVE    = os.path.join(ROOT, "models", "sign_stgcn_4stream_late.pth")
...
def train():
    ...
    out_json = os.path.join(OUTPUT_DIR, "results_4stream_late.json")
